  ...
  return (
    <div className=''>
      ...
      <div className="relative h-[80vh] flex max-sm:flex-col">
        ...
        <div className="relative w-[50%] h-full max-sm:w-full">
          <Image src='/heromain.jpg' fill alt="main" className="object-cover" />
          {/* Overlay for shading */}
          <div className="absolute inset-0 bg-black opacity-30 z-0"></div>
        ...
        <div className="absolute top-[0%] w-full z-10 px-10 py-7 gap-2 flex flex-col justify-center items-center text-white max-sm:h-full">
          ...
          <button className="bg-white text-black max-sm:px-5 max-sm:py-2 px-9 rounded-md py-3 font-semibold transition ease-in-out duration-300 hover:bg-slate-200">SHOP NOW</button>
        </div>
      </div>
